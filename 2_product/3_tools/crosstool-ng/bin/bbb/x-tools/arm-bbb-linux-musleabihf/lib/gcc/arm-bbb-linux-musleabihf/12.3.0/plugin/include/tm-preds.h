/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/home/aessam/aessam_emlinux_main_dev/2_product/3_tools/crosstool-ng/source/.build/arm-bbb-linux-musleabihf/src/gcc/gcc/config/arm/arm.md'.  */
